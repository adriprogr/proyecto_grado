...
<body>
                ...
                <div class="offcanvas offcanvas-end" id="offcanvasNavbar">
                    ...
                    <div class="offcanvas-body text-center">
                        <ul class="navbar-nav justify-content-end flex-grow-1 3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="Titulares_informativos.php">Noticias</a>
                            </li>
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave rounded" src="../../assets/img/fondo_Informativos.webp" alt="Imagen de artículo">
