...
<head>
    ...
    <title>Portal Informativos | Titulares</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    <link rel="stylesheet" href="../../assets/css/Titulares_informativos.css">
    <link rel="stylesheet" href="../../assets/css/Titulares_movil.css">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.9.1/font/bootstrap-icons.css">
    <link href="https://unpkg.com/aos@2.3.1/dist/aos.css" rel="stylesheet">
    <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.7.2/css/all.min.css" rel="stylesheet">
    <link rel="icon" type="image/x-icon" href="../../assets/icons/portal_informativos.ico">
...
<body>
    ...
    <section class="cabecera" id="inicio"> <!--Contenedor que incluye el fondo del header y que contendra toda la estructura del header con sus elementos-->
        ...
        <nav class="navbar navbar-expand-md "> <!--Empiezo a definir el header diciendo que se va a expandir hasta los dispositivos medianos-->
            <div class="container-fluid d-flex justify-content-between align-items-center"> <!--Contenedor donde se ajojara todo el contenido. Estos tienen estilos de bootstrap aplicando un display flex donde el contenido estara separado entre ellos-->
                <!-- Logo -->
                <a href="Titulares_informativos.php">
                    <img class="logo" data-aos="fade-up" data-aos-duration="1000" src="../../assets/img/noticias_informativos.webp" width="320px">
                </a>
                ...
                <div class="offcanvas offcanvas-end" id="offcanvasNavbar">
                    ...
                    <div class="offcanvas-header">
                        <img class="img-fluid" src="../../assets/img/noticias_informativos.webp" width="280px">
        ...
        <div class=" contenido-texto container-fluid" >
            <h1 data-aos="fade-up" data-aos-duration="1000">¡Bienvenidos a Portal Informativo donde estaras actualizado sobre las ultimas novedades que pasan en el mindo </h1>
            <p data-aos="fade-up" data-aos-duration="1000">En este Portal encontraras noticias de muchos temas diversos que pasan en el mundo como politica, deportes, actualidad, economia entre otros.</p>    
                                ...
                                <div class="modal-content"> <!--Contenido de la modal-->
                                    ...
                                    <div class="modal-body d-flex justify-content-center align-items-center"><!--Cuerpo de la modal-->
                                        <form action="../PHP/titulares_noticias.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id_categoria" value="2"> <!-- El valor 2 hace referencia a la categoria informativos de la base de datos -->
    ...
    <div id="carouselExampleAutoplaying" class="container carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" data-bs-interval="5000" data-aos="zoom-in-up" data-aos-duration="1000" id="Titulares">
        <?php
            $id_categoria = 2;
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4 text-center" data-aos="fade-up" data-aos-duration="600" >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#inicio" class="text-white text-decoration-none"><i class="bi bi-newspaper me-2"></i>INFORMATIVOS</a></li>
                ...
                <div class="col-lg-2 col-md-4 mb-4 text-center" data-aos="fade-up" data-aos-duration="600">
                    ...
                    <a href="https://discord.gg/By3qXUgV5P" target="_blank" class="text-white btn informativos "> <i class="fab fa-discord "></i></a>                  
                </div>
            </div>
        </div>
    </footer>
