...
<body>
    ...
    <section class="cabecera" > <!--Contenedor que incluye el fondo del header y que contendra toda la estructura del header con sus elementos-->
        <!-- Barra de navegacion-->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4 text-center">
                    <img src="../../assets/img/noticias_elite.webp" class="img-fluid mb-4" width="400px;">
                </div>
