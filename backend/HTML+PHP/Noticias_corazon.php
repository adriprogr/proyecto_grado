...
<head>
    ...
    <link rel="stylesheet" href="../../assets/css/Noticias_corazon.css">
...
<body>
    ...
    <!-- Barra de navegacion-->
        <nav class="navbar navbar-expand-md "> <!--Empiezo a definir el header diciendo que se va a expandir hasta los dispositivos medianos-->
            <div class="container-fluid d-flex justify-content-between align-items-center"> <!--Contenedor donde se ajojara todo el contenido. Estos tienen estilos de bootstrap aplicando un display flex donde el contenido estara separado entre ellos-->
                <a href="Titulares_corazon.php"  data-aos="fade-down" data-aos-duration="1000" >
                ...
                <!--Aqui detallamos la cabecera del menu offcanvas. En la cabecera tendra una imagen con el logo de la pagina que corresponda(puesto que habra varios logos) y un boton para cerrar dicho menu-->
                    <div class="offcanvas-header">
                        <img class="img-fluid" src="../../assets/img/noticias_corazon.webp" width="280px">
                    ...
                    <div class="offcanvas-body text-center" data-aos="fade-right" data-aos-duration="1000">
                        <ul class="navbar-nav justify-content-end flex-grow-1 3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Titulares_corazon.php">Noticias</a>
                            </li>
                            <?php
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave rounded" src="../../assets/img/fondo_corazon.webp" alt="Imagen de artículo">
                    ...
                    <div class="texto-carta">
                        ...
                        <a href="Titulares_corazon.php" class="btn">¡Quiero saber más!</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4 text-center" data-aos="fade-down" data-aos-duration="800" >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="Titulares_corazon.php" class="text-white text-decoration-none"><i class="bi bi-newspaper me-2"></i>NOTICIAS</a></li>
                        <?php
                            if(isset($_SESSION['nombre_usuario']) && isset($_SESSION['id_rol'])){
                                $rol = $_SESSION['id_rol'];
                                if ($rol == 1){
                ...
                <div class="col-lg-2 col-md-4 mb-4 text-center" data-aos="fade-down" data-aos-duration="1200">
                    ...
                    <a href="https://facebook.com" target="_blank" class="text-white btn facebook "> <i class="bi bi-facebook fs-5"></i></a>                  
                </div>
            </div>
        </div>
    </footer>
