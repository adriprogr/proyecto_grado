    ...
    <section class="cabecera" id="inicio"><!--Contenedor que incluye el fondo del header y que contendra toda la estructura del header con sus elementos-->
        ...
        <nav class="navbar navbar-expand-md ">
            ...
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <!--Contenedor donde se ajojara todo el contenido. Estos tienen estilos de bootstrap aplicando un display flex donde el contenido estara separado entre ellos-->
                <!-- Logo -->
                <a href="Titulares_gamer.php" data-aos="fade-down" data-aos-duration="1000">
                    <img class="logo" src="../../assets/img/noticias_gamer.webp" width="350px">
                </a>
                ...
                <button class="navbar-toggler btn btn-success" type="button" data-bs-toggle="offcanvas"
                    data-bs-target="#offcanvasNavbar">
                    <span class="navbar-toggler-icon"></span>
                    <!--Defino como va a ser el logo. En este caso sera un icono con tres rayas laterales(icono de bootstrap)-->
                </button>
                ...
                <div class="offcanvas offcanvas-end" id="offcanvasNavbar" data-aos="fade-right" data-aos-duration="1000">
                    ...
                    <div class="offcanvas-header">
                        <img class="img-fluid" src="../../assets/img/noticias_gamer.webp" width="280px">
                    ...
                    <div class="offcanvas-body text-center" data-aos="fade-right" data-aos-duration="1000">
                        <ul class="navbar-nav justify-content-end flex-grow-1 3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="Titulares_gamer.php">Noticias</a>
                            </li>
