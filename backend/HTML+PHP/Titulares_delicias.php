...
<body>
    <section class="cabecera" id="inicio"> <!--Contenedor que inclute el fondo del header y que contendra toda la estructura del header con sus elementos-->
        ...
        <div class=" contenido-texto container-fluid">
            <h1>¡Bienvenidos a Portal Delicias donde estaras actualizado sobre las ultimas novedades del mundo de la cocina de todas las partes del mundo </h1>
            <p>En este Portal encontraras noticias sobre la comida mas exquisita perteneciente a cualquier parte del mundo.</p>    
