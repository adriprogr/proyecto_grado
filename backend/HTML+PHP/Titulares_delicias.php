...
<head>
    ...
    <title>Titulares Delicias</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    <link rel="stylesheet" href="../../assets/css/Titulares_delicias.css">
...
<body>
    ...
    <section class="cabecera" id="inicio"> <!--Contenedor que incluye el fondo del header y que contendra toda la estructura del header con sus elementos-->
        ...
        <nav class="navbar navbar-expand-md "> <!--Empiezo a definir el header diciendo que se va a expandir hasta los dispositivos medianos-->
            ...
            <!-- Logo -->
                <a href="Titulares_delicias.php">
                    <img class="logo" data-aos="fade-up" data-aos-duration="1000"  src="../../assets/img/noticias_delicias.webp" width="320px">
                </a>
        ...
        <div class=" contenido-texto container-fluid">
            <h1 data-aos="fade-up" data-aos-duration="1000">¡Bienvenidos a Portal Delicias donde estaras actualizado sobre las ultimas novedades del mundo de la cocina de todas las partes del mundo </h1>
            <p data-aos="fade-up" data-aos-duration="1000">En este Portal encontraras noticias sobre la comida mas exquisita perteneciente a cualquier parte del mundo.</p>    
                                ...
                                <div class="modal-content"> <!--Contenido de la modal-->
                                    ...
                                    <div class="modal-body d-flex justify-content-center align-items-center"><!--Cuerpo de la modal-->
                                        <form action="../PHP/titulares_noticias.php" method="POST" enctype="multipart/form-data">
                                            ...
                                            <input type="hidden" name="id_categoria" value="3"> <!-- El valor 3 hace referencia a la categoria delicias de la base de datos -->
    ...
    <!--Carrusel y primera parte perteneciente al body-->
        ...
        <div class="carousel-inner" id="Titulares" data-bs-interval="5000">
            <?php
                ...
                if(mysqli_num_rows($primer_carousel) > 0 && mysqli_num_rows($carousel_restante) > 0){
                    ...
                    while ($row = mysqli_fetch_assoc($carousel_restante)) {
                        echo ' 
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4 text-center" data-aos="fade-up" data-aos-duration="600" >
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#inicio" class="text-white text-decoration-none"><i class="bi bi-egg-fried me-2"></i>DELICIAS</a></li>
                ...
                <div class="col-lg-2 col-md-4 mb-4 text-center" data-aos="fade-up" data-aos-duration="600">
                    ...
                    <a href="https://discord.gg/By3qXUgV5P" target="_blank" class="text-white btn delicias "> <i class="fab fa-discord "></i></a>                  
                </div>
            </div>
        </div>
    </footer>
