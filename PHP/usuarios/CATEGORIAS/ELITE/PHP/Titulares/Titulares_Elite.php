<?php
    ...
    if(!isset($_SESSION['nombre_usuario'])){
        echo '
        <script>
            alert("Debes iniciar sesion para acceder a este portal");
            window.location.href = "../../../../INICIO/PHP/inicio.php";
        </script>
        ';
    }
?>
...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/Titulares/Titulares_elite.css">
...
<body>
    <section class="cabecera" id="inicio"> <!--Contenedor que inclute el fondo del header y que contendra toda la estructura del header con sus elementos-->
        ...
        <nav class="navbar navbar-expand-md "> <!--Empiezo a definir el header diciendo que se va a expandir hasta los dispositivos medianos-->
            <div class="container-fluid d-flex justify-content-between align-items-center"> <!--Contenedor donde se ajojara todo el contenido. Estos tienen estilos de bootstrap aplicando un display flex donde el contenido estara separado entre ellos-->
                ...
                <a href="Titulares_Elite.php">
                    <img class="logo" src="../../imagenes/image-removebg-preview (41).png" width="320px">
                </a>
                ...
                <div class="offcanvas offcanvas-end" id="offcanvasNavbar">
                    ...
                    <div class="offcanvas-header">
                        <img class="img-fluid" src="../../imagenes/image-removebg-preview (41).png" width="280px">
        ...
        <div class=" contenido-texto container-fluid">
            ...
            <a href="#titulares" class="text-decoration-none"><button type="button" class="btn btn-lg">¡Echar un vistazo!</button></a>
            <!--Seccion de sugerencias (Exclusiva de este portal) -->
            <button class="btn btn-primary disposicion"  data-bs-target="#modal2" data-bs-toggle="modal" >Crea tu propia noticia</button>
                ...
                <div class="modal-dialog modal-dialog-centered"> <!--Especificamos el entorno de la modal-->
                    <div class="modal-content"> <!--Contenido de la modal-->
                        ...
                        <div class="modal-body">
                            <form action="../Comentarios/comentarios.php" method="POST" enctype="multipart/form-data">
                                <h1 class="text-center mb-4" style="color: black;">Crea tu propia noticia </h1>
                                ...
                                <div class="mb-3">
                                    <label for="Titular" class="form-label" style="color: black;">Introduzca el titular de la noticia</label>
                                    <input type="text" class="form-control"  name="titular" placeholder="Titular de la noticia">
                                </div>

                                <div class="mb-3">
                                    <label for="Descripcion" class="form-label" style="color: black;">Dinos de que quieres que se trate</label>
        ...
        <div class="carousel-inner" id="titulares" data-bs-interval="5000">
            ...
            <div class="carousel-item active">
                ...
                <div class="carousel-caption">
                    ...
                    <a href="../Noticias/Noticias_Elite.php" class="btn">¡Quiero saber más!</a>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 mb-4">
                    <img src="../../imagenes/image-removebg-preview (41).png" class="img-fluid mb-4" width="410px;">
                </div>
