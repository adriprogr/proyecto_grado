...
<head>
    ...
    <link rel="stylesheet" href="../CSS/inicio_movil.css">
...
<body>
    <section class="cabecera" id="inicio">
        <nav class="navbar navbar-expand-md">
            <div class="container-fluid d-flex justify-content-between align-items-center">
                <a href="Inicio.php">
                    <img src="../imagenes/Logo.png" alt="" class="logo" width="160px">
                </a>
                ...
                <div class="offcanvas offcanvas-end" id="offcanvasNavbar">
                    <div class="offcanvas-header">
                        <img class="img-fluid" src="../imagenes/Logo.png" width="200px">
    ...
    <section class="contenedor container-fluid text-center" id="dedicacion">
        <div class="row">
            ...
            <div class="imagenes d-flex flex-column col-lg-6" >
                <img class="img-fluid" src="../imagenes/Demostracion1.png" width="400x" alt="">
                <img class="imagen_clave img-fluid" src="../imagenes/Demostracion2.png" width="370px" height="200px" alt="">
            </div>
    ...
    <section class="contenedor container-fluid text-center" id="categorias">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave" src="../imagenes/corazon.jpg" alt="Imagen de artículo">
                    <img class="logito" src="../imagenes/logo2.png"  alt="Logo del portafolio">
                ...
                <div class="modal-dialog modal-dialog-centered"> <!--Especificamos el entorno de la modal-->
                    <div class="modal-content"> <!--Contenido de la modal-->
                        <div class="modal-header"> <!--Cabecera de la modal-->
                            <img src="../imagenes/logo2.png" class="img-fluid" width="120px" alt="">
                        ...
                        <div class="modal-footer d-flex justify-content-between"><!--Pie de pagina de la modal--><!--Pie de pagina de la modal-->
                            <a href="../../CATEGORIAS/CORAZON/PHP/Titulares/Titulares_corazon.php" class="boton_categorias corazon text-decoration-none">Visitar Portal</a>
            ...
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave" src="../imagenes/Informativos.jpg" alt="Imagen de artículo">
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img src="../imagenes/logo3.png" class="img-fluid" width="120px" alt="">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        ...
                        <div class="modal-footer d-flex justify-content-between"><!--Pie de pagina de la modal-->
                            <a href="../../CATEGORIAS/INFORMATIVOS/PHP/Titulares/Titulares_informativos.php" class="boton_categorias informativos text-decoration-none">Visitar Portal</a>
                            <button type="button" class="cerrar" data-bs-dismiss="modal" aria-label="Close">Cerrar</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave" src="../imagenes/delicias.png" alt="Imagen de artículo">
                    <img class="logito" src="../imagenes/logo4.png"  alt="Logo del portafolio">
            ...
            <div class="modal fade" id="modal3">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img src="../imagenes/logo4.png" class="img-fluid" width="120px" alt="">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer d-flex justify-content-between"><!--Pie de pagina de la modal-->
                            <a href="../../CATEGORIAS/DELICIAS/PHP/Titulares/Titulares_delicias.php" class="boton_categorias delicias text-decoration-none">Visitar Portal</a>
                            <button type="button" class="cerrar" data-bs-dismiss="modal" aria-label="Close">Cerrar</button>
                        </div>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="carta">
                    <img class="clave" src="../imagenes/Gamer.jpg" alt="Imagen de artículo">
            ...
            <div class="modal fade" id="modal4">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer d-flex justify-content-between"><!--Pie de pagina de la modal-->
                            <a href="../../CATEGORIAS/GAMER/PHP/Titulares/Titulares_gamer.php" class="boton_categorias gamer text-decoration-none">Visitar Portal</a>
                            <button type="button" class="cerrar" data-bs-dismiss="modal" aria-label="Close">Cerrar</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-6">
                <div class="carta">
                    <img class="clave" src="../imagenes/Comunidad.jpg" alt="Imagen de artículo">
                    <img class="logito" src="../imagenes/logo6.png"  alt="Logo del portafolio">
            ...
            <div class="modal fade" id="modal5">
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        <div class="modal-header">
                            <img src="../imagenes/logo6.png" class="img-fluid" width="120px" alt="">
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer d-flex justify-content-between">
                            ...
                            if(isset($_SESSION['nombre_usuario'])) {
                                ?>
                                    <a href="../../CATEGORIAS/ELITE/PHP/Titulares/Titulares_Elite.php" class="boton_categorias élite text-decoration-none">Visitar Portal</a>
                                <?php
                            } else {
                                ?>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row">
                <div class="col-lg-4">
                    <img src="../imagenes/logo.png"class="img-fluid mb-4" width="200px;">
                </div>
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="../../CATEGORIAS/CORAZON/PHP/Titulares/Titulares_corazon.php" class="text-white text-decoration-none"><i class="bi bi-heart me-2"></i>CORAZON</a></li>
                        <li class="mb-2"><a href="../../CATEGORIAS/INFORMATIVOS/PHP/Titulares/Titulares_informativos.php" class="text-white text-decoration-none"><i class="bi bi-newspaper me-2"></i>INFORMATIVOS</a></li>
                        <li class="mb-2"><a href="../../CATEGORIAS/DELICIAS/PHP/Titulares/Titulares_delicias.php" class="text-white text-decoration-none"><i class="bi bi-egg-fried me-2"></i>DELICIAS</a></li>
                        <li class="mb-2"><a href="../../CATEGORIAS/GAMER/PHP/Titulares/Titulares_gamer.php" class="text-white text-decoration-none"><i class="bi bi-controller me-2"></i>GAMING</a></li>
                        <?php
                        if(isset($_SESSION['nombre_usuario'])) {
                            ?>
                                <li class="mb-2"><a href="../../CATEGORIAS/ELITE/PHP/Titulares/Titulares_Elite.php" class="text-white text-decoration-none"><i class="bi bi-people me-2"></i>ÉLITE</a></li>
                            <?php
                        } else {
                            ?>
