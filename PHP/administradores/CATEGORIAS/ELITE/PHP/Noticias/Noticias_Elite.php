...
<body>
    <section class="cabecera"> <!--Contenedor que inclute el fondo del header y que contendra toda la estructura del header con sus elementos-->
        <!-- Barra de navegacion-->
        <nav class="navbar navbar-expand-md "> <!--Empiezo a definir el header diciendo que se va a expandir hasta los dispositivos medianos-->
            <div class="container-fluid d-flex justify-content-between align-items-center"> <!--Contenedor donde se ajojara todo el contenido. Estos tienen estilos de bootstrap aplicando un display flex donde el contenido estara separado entre ellos-->
                <!-- Logo -->
                <a href="Noticias_Elite.php">
                    <img class="logo" src="../../imagenes/image-removebg-preview (41).png" width="350px">
                </a>
                ...
                <!--Aqui detallamos la cabecera del menu offcanvas. En la cabecera tendra una imagen con el logo de la pagina que corresponda(puesto que habra varios logos) y un boton para cerrar dicho menu-->
                    ...
                    <div class="offcanvas-body text-center">
                        <ul class="navbar-nav justify-content-end flex-grow-1 3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="../Titulares/Titulares_Elite.php">Noticias</a>
                            </li>
    ...
    <section class="container titular mt-4">
        <article>
            ...
            <img src="../../imagenes/Comunidad.jpg"class="img-fluid mb-4 rounded imagen-articulo">
    ...
    <section class="container">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave rounded" src="../../imagenes/Comunidad.jpg" alt="Imagen de artículo">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="../Titulares/Titulares_Elite.php" class="text-white text-decoration-none"><i class="bi bi-newspaper me-2"></i>NOTICIAS</a></li>
                        <?php
                        if(isset($_SESSION['nombre_usuario'])){
                            echo '  
                                <li class="nav-item dropdown">
                ...
                <div class="col-lg-2 col-md-4 col-6 mb-4">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="../Titulares/Titulares_Elite.php" class="text-white text-decoration-none"><i class="bi bi-people me-2"></i>ÉLITE</a></li>
                    </ul>
                </div>
