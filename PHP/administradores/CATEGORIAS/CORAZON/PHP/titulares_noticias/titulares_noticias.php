<?php   
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        foreach($img as $imagenes){ /*Recorro cada valor del array*/
            ...
            $rutas_imagenes[] = $ruta; /* Aqui creo un array vacio donde se iran guardando todas las imagenes que vaya guardando en la ruta definitiva */
            ...
            if($resultado_titular) {
                ...
                if($resultado_noticias) {
                    ...
                    window.location.href="../Titulares/Titulares_corazon.php";
                    </script>
                    ';
            } else {
                echo '<script>
