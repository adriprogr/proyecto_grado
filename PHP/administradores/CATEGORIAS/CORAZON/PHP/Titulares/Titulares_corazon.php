...
<head>
    ...
    <link rel="stylesheet" href="../../CSS/Titulares/Titulares_corazon.css">
                    ...
                    <div class="modal-content"> <!--Contenido de la modal-->
                        ...
                        <div class="modal-body d-flex justify-content-center align-items-center"><!--Cuerpo de la modal-->
                            <form action="../titulares_noticias/titulares_noticias.php" method="POST" enctype="multipart/form-data">
                                ...
                                <input type="hidden" name="id_categoria" value="1"> <!-- El valor 1 hace referencia a la categoria corazon de la base de datos -->
  ...
  <!--Carrusel-->
    <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        ...
        <div class="carousel-inner" data-bs-interval="5000" id="Titulares">
            ...
            <div class="carousel-item" data-bs-interval="5000">
                <img src="../../imagenes/corazon.png" class="d-block w-100" alt="...">
                <div class="carousel-caption">
                    <h5>Lorem ipsum dolor sit amet consectetur adipisicing elit. Totam, voluptas?</h5>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Magnam, dicta?</p>
                    <a href="../Noticias/Noticias_corazon.php" class="btn">¡Quiero saber más!</a>
    ...
    <section class="container ">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="carta">
                    <img class="clave" src="../../imagenes/corazon.png" alt="Imagen de artículo">
                    ...
                    <div class="texto-carta">
                        ...
                        <a href="../Noticias/Noticias_corazon.php"><button class="btn">Me interesa</button></a>
                    </div>
                </div>
            </div>
